...
namespace PageObjectPatternDemo
{
    ...
    public class OpinionsTests : Configuration
    {
        ...
        */
        ...
        {
            PageObjectPatternDemo.Opinions.letMeSeeIfThisUglyIdeaWorks(webDriver); // remember to removed static keywords from IWebDriver and this ugly method in ElementsMethods file
        }
